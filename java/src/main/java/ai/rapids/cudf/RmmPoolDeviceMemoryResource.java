 ...
 */
public class RmmPoolDeviceMemoryResource<C extends RmmDeviceMemoryResource>
   ...
   */
  public RmmPoolDeviceMemoryResource(C wrapped, long initSize, long maxSize) {
    super(wrapped);
    this.initSize = initSize;
    this.maxSize = maxSize;
    handle = Rmm.newPoolMemoryResourceDevice(wrapped.getHandle(), initSize, maxSize);
  }
