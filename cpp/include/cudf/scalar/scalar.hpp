...
class scalar {
 ...
 protected:
  ...
  cudf::device_scalar<bool> _is_valid;  ///< Device bool signifying validity
...
class fixed_width_scalar : public scalar {
 ...
 protected:
  cudf::device_scalar<T> _data;  ///< device memory containing the value
   ...
   * @param mr Device memory resource to use for device memory allocation.
   */
  fixed_width_scalar(cudf::device_scalar<T>&& data,
                     bool is_valid                     = true,
                     rmm::cuda_stream_view stream      = cudf::get_default_stream(),
                     rmm::device_async_resource_ref mr = rmm::mr::get_current_device_resource());
};
...
class numeric_scalar : public detail::fixed_width_scalar<T> {
 ...
 public:
   ...
   * @param mr Device memory resource to use for device memory allocation.
   */
  numeric_scalar(cudf::device_scalar<T>&& data,
                 bool is_valid                     = true,
                 rmm::cuda_stream_view stream      = cudf::get_default_stream(),
                 rmm::device_async_resource_ref mr = rmm::mr::get_current_device_resource());
};
...
class fixed_point_scalar : public scalar {
 ...
 public:
   ...
   * @param mr Device memory resource to use for device memory allocation.
   */
  fixed_point_scalar(cudf::device_scalar<rep_type>&& data,
                     numeric::scale_type scale,
                     bool is_valid                     = true,
                     rmm::cuda_stream_view stream      = cudf::get_default_stream(),
                     rmm::device_async_resource_ref mr = rmm::mr::get_current_device_resource());
 ...
 protected:
  cudf::device_scalar<rep_type> _data;  ///< device memory containing the value
};
...
class string_scalar : public scalar {
 public:
   ...
   * @param mr Device memory resource to use for device memory allocation.
   */
  string_scalar(cudf::device_scalar<value_type>& data,
                bool is_valid                     = true,
                rmm::cuda_stream_view stream      = cudf::get_default_stream(),
                rmm::device_async_resource_ref mr = rmm::mr::get_current_device_resource());
...
class chrono_scalar : public detail::fixed_width_scalar<T> {
 ...
 public:
   ...
   * @param mr Device memory resource to use for device memory allocation.
   */
  chrono_scalar(cudf::device_scalar<T>&& data,
                bool is_valid                     = true,
                rmm::cuda_stream_view stream      = cudf::get_default_stream(),
                rmm::device_async_resource_ref mr = rmm::mr::get_current_device_resource());
};
