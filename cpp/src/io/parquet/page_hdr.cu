 ...
 */
__device__ uint32_t kernel_mask_for_page(
  PageInfo const& page, ColumnChunkDesc const& chunk, bool use_fixed_op)
{
...
__global__ void __launch_bounds__(128)
  gpuDecodePageHeaders(ColumnChunkDesc* chunks, int32_t num_chunks, int32_t* error_code, bool use_fixed_op)
{
